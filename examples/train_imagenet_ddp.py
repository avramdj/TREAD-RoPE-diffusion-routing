...
def main() -> None:
    load_dotenv()
    parser = argparse.ArgumentParser(description="Train SiT on ImageNet.int8 latents (SDXL VAE)")
    ...
    parser.add_argument("--save-name", type=str, default="sit-latest")
    parser.add_argument(
    ...
    @torch.no_grad()
    def ema_update(ema: SiT, online: SiT, decay: float, compiled: bool = True) -> None:
